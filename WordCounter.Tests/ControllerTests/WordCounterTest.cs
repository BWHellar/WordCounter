...
namespace WordCounter.Tests
{
  ...
  public class WordCounterControllerTest
  {
    ...
    // Passed: We are doing two things of this test.  First, This makes sure that the specified object is an instance of the current type.  We specifically want to make sure View is the returned instance of CreateCount. (Making sure that the WordCounterController does its job).  Second, This test method looks to check if this will return the right result.  This is done in order to see if the new controller properly functions with our WordCounter.
    [TestMethod]
